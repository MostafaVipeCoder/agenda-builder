...
const ExpertManager = () => {
    ...
    const loadExperts = async () => {
        try {
            ...
            setError('Failed to establish link with Expert Grid.');
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-32 text-center">
                        ...
                        <h2 className="text-2xl font-black text-[#0d0e0e] tracking-tight mb-2">No Visionaries Detected</h2>
                        <p className="text-slate-400 text-sm font-bold uppercase tracking-widest">The signal is clear but your roster is empty.</p>
                        <button
